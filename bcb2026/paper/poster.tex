...
\textbf{Code and data.}
Full MIT-licensed pipeline (BEELINE preprocessing, scGPT and
Geneformer attention extraction, baselines, universe-aware
evaluation, DeLong AUROC CI with paired AUPR bootstrap, Type-II ANOVA,
paper-number trace) at
\url{https://github.com/Biodyn-AI/grn-evaluation-bias}, with the
pinned HGNC dictionary, BEELINE SHA checks, and a conda lockfile. All
numbers above are emitted verbatim by the pipeline.
