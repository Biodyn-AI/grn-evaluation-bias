...
\url{https://anonymous.4open.science/r/grn-evaluation-bias-DE97/}
(anonymous mirror for blind review), with the pinned HGNC dictionary,
BEELINE SHA checks, and a conda lockfile. All numbers above are
emitted verbatim by the pipeline.
